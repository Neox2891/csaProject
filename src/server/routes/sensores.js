...
import { rezoned } from '../config/config';
import { getDataDay } from '../helpers/getDataDay';
import { getDataMonth } from '../helpers/getDataMonth';
...
router.get('/datos/search', (req, res) => {
...
router.get('/datos/:mesAno', (req, res) => {
